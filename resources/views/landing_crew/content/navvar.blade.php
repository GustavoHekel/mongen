    ...
    <div class="container">
        ...
        <nav class="navbar navbar-default">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <div id="cotainer-logueo" style="text-align: right">
                    <form id="ingreso" class="form-inline" role="form" >
                        ...
                        <button type="button" class="btn btn-primary btn-sm" id="enviardatos">Submit</button>
                    </form>
                </div>
