			...
			<div class="col-md-8 col-md-offset-2 text-center animate-box">
				...
				<div class="flexslider-controls">
					<ol class="flex-control-nav">
						<li class="animate-box"><img src="{{ asset("dist/plugins/guide/images/person4.jpg")}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co"></li>
						<li class="animate-box"><img src="{{ asset("dist/plugins/guide/images/person2.jpg")}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co"></li>
						<li class="animate-box"><img src="{{ asset("dist/plugins/guide/images/person3.jpg")}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co"></li>
					</ol>
				</div>
			</div>
		</div>
