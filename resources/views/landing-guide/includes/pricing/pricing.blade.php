		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 animate-box">
				<div class="price-box popular">
					...
					<div class="price"><sup class="currency">$</sup>9,99<small>/mes</small></div>
			...
			<!-- <div class="col-md-2 col-sm-6 animate-box">
				<div class="price-box">
					...
					<div class="price"><sup class="currency">$</sup>19<small>/mes</small></div>
					<p>Basic customer support for small business</p>
					<hr>
					<ul class="pricing-info">
						<li>15 projects</li>
			...
			<div class="col-md-2 col-sm-6 animate-box">
				<div class="price-box popular">
					...
					<div class="price"><sup class="currency">$</sup>79<small>/mes</small></div>
					<p>Basic customer support for small business</p>
					<hr>
					<ul class="pricing-info">
			...
			<div class="col-md-2 col-sm-6 animate-box">
				<div class="price-box">
					...
					<div class="price"><sup class="currency">$</sup>125<small>/mes</small></div>
					<p>Basic customer support for small business</p>
					<hr>
					<ul class="pricing-info">
						<li>Unlimitted projects</li>
